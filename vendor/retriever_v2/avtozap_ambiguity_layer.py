...
CONTEXT_RULES = [
    ...
    # --- найдено проверкой новых слов 01.09 ---
    ("radiator",  ["bacok", "bacoku", "su bacoku"], "SO-008"),      # бачок радиатора, не омывателя
    ("radyator",  ["bacok", "bacoku", "su bacoku"], "SO-008"),
    ("eylec",     ["disk", "diski", "diskleri"], "EY-002"),          # тормозной диск, не колёсный
    ("tormuz",    ["disk", "diski", "diskleri"], "EY-002"),
    ("tormoz",    ["disk", "diski", "diskleri"], "EY-002"),
    ("most",      ["paduska", "paduskalari", "yastiq"], "AS-025"),  # подушки моста = сайлентблок балки
    ("mosd",      ["paduska", "paduskalari"], "AS-025"),
    ("stupitsa",  ["pacelnik", "pacennik", "podsipnik"], "AS-007"),
    ("stupsiya",  ["pacelnik", "pacennik", "podsipnik"], "AS-007"),
    # --- из ошибок на эталоне 469 ---
    ("guzgu",     ["isiq", "isigi", "pavarotnik", "povorotnik"], "KZ-069"),
    ("guzgu",     ["sise", "sesi", "susesi"], "KZ-021"),
    ("baqaj",     ["kece", "kecesi", "kovir"], "AK-005"),
    ("baqaj",     ["jaluz", "jaluzi", "perde"], "KZ-070"),
    ("baqaj",     ["obivka", "obivkasi", "plasmasi", "uzluyu"], "KZ-034"),
    ("radiator",  ["barmaq", "barmaqliq", "barmaqlig", "setka"], "KZ-028"),
    ("kompressor",["datcik", "daccik", "datciki", "daciki", "sensor"], "EL-020"),
    ("kompresor", ["datcik", "daccik", "datciki", "daciki"], "EL-020"),
    ("katalizator",["datcik", "daccik", "daccikleri", "sensor"], "EG-002"),
    ("kardan",    ["mufta", "muftasi"], "TR-013"),
    ("bufer",     ["diffuzer", "diffuzeri", "difuzer"], "TY-004"),
    ("kapot",     ["peredoxranitel", "predoxranitel", "blokunun qapagi"], "RG-10"),
    ("kriska",    ["prokladka", "prokladkasi", "proklatka"], "MU-014"),
    ("krisqa",    ["prokladka", "prokladkasi", "proklatka"], "MU-014"),
    ("teker",     ["datcik", "daccik", "datciki", "sensor", "teziq"], "TK-005"),
    ("amartizator",["pocevnik", "pacevnik", "podsipnik"], "AS-003"),
    ("amortizator",["pocevnik", "pacevnik", "podsipnik"], "AS-003"),
    ("stop",      ["led", "ledli", "stoplar"], "KZ-007"),
    ("led",       ["fara", "faralar"], "KZ-005"),
    ("motor",     ["alt", "zasitnik", "zasitniki", "qoruyucu"], "MU-053"),
    ("radiator",  ["kriska", "kriskasi", "krishka", "qapaq"], "SO-039"),
    ("radiator",  ["fan", "fani", "per", "peri"], "SO-002"),
    ("radiator",  ["termostat", "geden", "patrubka", "slanq"], "SO-009"),
    ("kompressor",["maqnit", "maqniti", "skif", "skfi", "skiv"], "SO-033"),
    ("amortizator",["ust dayaq", "dayagi", "ust rezin", "paduska", "paduskalari"], "AS-002"),
    ("amartizator",["ust dayaq", "dayagi", "ust rezin", "paduska", "paduskalari"], "AS-002"),
    ("stop",      ["suse", "susesi", "sise"], "KZ-048"),
    ("balka",     ["razval", "razvalni", "rezin", "rezinler"], "AS-025"),
    ("stabilizator",["rezin", "rezini", "paduska"], "AS-012"),
    ("guzgu",     ["qapaq", "qapaqi", "qapagi", "korpus"], "KZ-022"),
    ("qapi",      ["alti kant", "altinin kant", "alt kant"], "KZ-092"),
    ("qapi",      ["ustu nikel", "nikel kant", "nikkel kant"], "KZ-094"),
    ("bufer",     ["alt qoruyucu", "alt zasitnik", "yubka"], "KZ-076"),
    ("bufer",     ["setka", "abilsofka setka"], "KZ-086"),
    ("mator",     ["yag krisqa", "yag qapag", "yag kriska"], "MU-057"),
    ("matorun",   ["yag krisqa", "yag qapag", "yag kriska"], "MU-057"),
    ("kriska",    ["ust", "usd"], "MU-013"),
    ("dinamo",    ["skif", "shkif", "skiv"], "MU-021"),
    ("kompressor",["kransteyn", "kronsteyn", "kransteyni"], "SO-036"),
    # turbo
