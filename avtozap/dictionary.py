"""Словарь AVTOZAP на 571 деталь — единственный источник истины по кодам.
...
Версия от 01.09.2026: 571 деталь. Заведены 30 новых, среди них KZ-094 и
KZ-095, из-за которых три строки эталона раньше нельзя было засчитать, — теперь
считаются все 469.
"""
